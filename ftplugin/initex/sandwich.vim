...
if !exists('s:local_recipes')
  let s:local_recipes = [
        ...
        \   {'__filetype__': 'initex', 'buns': ['\bigleft(',        '\bigright)'],        'nesting': 1, 'input': [ 'M(' ], 'filetype': ['initex', 'plaintex', 'tex'], 'indentkeys-': '(,)'},
        \   {'__filetype__': 'initex', 'buns': ['\bigleft[',        '\bigright]'],        'nesting': 1, 'input': [ 'M[' ], 'filetype': ['initex', 'plaintex', 'tex'], 'indentkeys-': '[,]'},
        \   {'__filetype__': 'initex', 'buns': ['\bigleft|',        '\bigright|'],        'nesting': 1, 'input': [ 'M|' ], 'filetype': ['initex', 'plaintex', 'tex']},
        \   {'__filetype__': 'initex', 'buns': ['\bigleft\{',       '\bigright\}'],       'nesting': 1, 'input': [ 'M{' ], 'filetype': ['initex', 'plaintex', 'tex'], 'indentkeys-': '{,},0{,0}'},
        \   {'__filetype__': 'initex', 'buns': ['\bigleft\langle ', '\bigright\rangle '], 'nesting': 1, 'input': [ 'M<' ], 'filetype': ['initex', 'plaintex', 'tex']},
        \   {
        \     '__filetype__': 'initex',
