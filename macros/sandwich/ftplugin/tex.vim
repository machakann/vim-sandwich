...
if !exists('s:local_recipes')
  let s:local_recipes = [
        ...
        \   {'__filetype__': 'tex', 'buns': ['\big(',         '\big)'],          'nesting': 1, 'input': [ 'M(' ], 'action': ['add'], 'indentkeys-': '(,)'},
        \   {'__filetype__': 'tex', 'buns': ['\big[',         '\big]'],          'nesting': 1, 'input': [ 'M[' ], 'action': ['add'], 'indentkeys-': '[,]'},
        \   {'__filetype__': 'tex', 'buns': ['\bigl|',        '\bigr|'],         'nesting': 1, 'input': [ 'M|' ], 'action': ['add']},
        \   {'__filetype__': 'tex', 'buns': ['\big\{',        '\big\}'],         'nesting': 1, 'input': [ 'M{' ], 'action': ['add'], 'indentkeys-': '{,},0{,0}'},
        \   {'__filetype__': 'tex', 'buns': ['\big\langle ',  '\big\rangle '],   'nesting': 1, 'input': [ 'M<' ], 'action': ['add']},
        \   {
        \     '__filetype__': 'tex',
